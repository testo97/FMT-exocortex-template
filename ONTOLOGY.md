...
| **Артефакты** | U.Work | DS-my-strategy/, Pack-репо, проекты, Цифровой двойник | Нет результата |
...
L1: Ecosystem    — платформа + сообщество + все IWE пользователей + МИМ
  L2: Platform   — инфраструктура и сервисы (бот, MCP-серверы, Knowledge Index)
    L3: Template — этот шаблон (CLAUDE.md + memory/ + стратег + DS-my-strategy/)
...
## Стратегический хаб (DS-my-strategy)
...
**Паттерн:** Hub-and-Spoke — DS-my-strategy (хаб) координирует, WORKPLAN.md (споки) в каждом репо.
...
**User-space (не обновляется):** MEMORY.md, DS-my-strategy/, личные планы.
