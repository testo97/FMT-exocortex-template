...
|-------|------|---------|------|
| УрФУ, проектное обучение, ПП, практики, кураторы, ИнФО, ИРИТ | `Pack-urfu` | UP | `/Users/user/Github/Pack-urfu/` |
| Личная продуктивность, задачи, заметки, проекты, управление знаниями | `Pack-personal` | PER | `/Users/user/Github/Pack-personal/` |
...
| Правило (глобальное) | `rule` | `/Users/user/Github/CLAUDE.md` | Строки |
