...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _/home/misha/Github/PACK-my-domain/pack/my-domain/_ |
...
| Правило (глобальное) | `rule` | `/home/misha/Github/CLAUDE.md` | Строки |
